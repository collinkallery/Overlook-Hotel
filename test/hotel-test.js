...
describe('Hotel', function() {
  ...
  beforeEach(() => {
    ...
    chai.spy.on(domUpdates, "displayRevenue", () => {});
  ...
  it('should set up the dashboard for the manager', function() {
    hotel.setUpManager();
    ...
    expect(domUpdates.displayRevenue).to.have.been.called.with(hotel.todayRevenue, hotel.allTimeRevenue);
  })
})
